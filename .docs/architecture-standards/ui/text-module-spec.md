...
Following the [Reference UI Module Architecture](file:///d:/Magazine/_PigmentShop/architecture-standards/ui/reference-module-spec.md), the `Text` primitive adheres to the standard module layout:
