...
> [!NOTE]
> This engineering standard defines the concrete module architecture, component model, public API, design tokens, hook extractions, and evolutionary rules for the **`Card`** UI primitive across PigmentShop, implementing [_reference-module-spec.md](./_reference-module-spec.md).
...
├── CardGridContainer.js   # Container component for card grids
├── CardShadow.js          # Shared shadow presentation logic
├── NavigationCard.js      # Card variant optimized for navigation
...
All consumers must import card elements exclusively from `src/components/ui/Card/index.js`.

### Export Contract:
```javascript
export { default, default as Card } from './Card';
export { CardGridContainer } from './CardGridContainer';
export { CardShadow } from './CardShadow';
