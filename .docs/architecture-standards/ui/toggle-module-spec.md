...
> [!NOTE]
> This engineering standard defines the architecture, API contracts, decomposition rules, and design token integration for the **`Toggle`** (Option / View Selection) UI primitive across PigmentShop, implementing [.docs/architecture-standards/01-reference-ui-module.md](file:///d:/Magazine/_PigmentShop/.docs/architecture-standards/01-reference-ui-module.md).
