...
> [!NOTE]
> This engineering standard defines the concrete module architecture, component model, public API, design tokens, hook extractions, and evolutionary rules for the **`Flag`** UI primitive across PigmentShop, implementing [architecture-standards/ui/reference-module-spec.md](file:///d:/Magazine/_PigmentShop/architecture-standards/ui/reference-module-spec.md).
