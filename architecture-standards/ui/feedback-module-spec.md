...
> [!NOTE]
> Defines the architectural specification, directory layout, decomposition rules, API contract standards, and design token integration for feedback primitives (`Toast`, `Skeleton`, `EmptyState`, `InlineError`).
