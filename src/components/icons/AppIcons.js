...
export const ThemeSunIcon = ({ color, size = 18, style, ...props }) => {
  if (Platform.OS === 'web') {
    return (
      <svg width={size} height={size} viewBox={iconTokens.viewBox} fill={iconTokens.fillNone} stroke={getThemeColor(color)} strokeWidth={iconTokens.strokeWidth.default} strokeLinecap="round" strokeLinejoin="round" style={appIconStyles.getSvg(style)} {...props}>
...
export const ThemeMoonIcon = ({ color, size = 18, style, ...props }) => {
  ...
  return <RNText style={appIconStyles.getText(color, size, style)} {...props}>🌙</RNText>;
};
...
export const HeartIcon = ({ filled, color, size = 18, style, ...props }) => {
  if (Platform.OS === 'web') {
    return (
      <svg width={size} height={size} viewBox={iconTokens.viewBox} fill={filled ? getThemeColor(color) : iconTokens.fillNone} stroke={getThemeColor(color)} strokeWidth={iconTokens.strokeWidth.default} strokeLinecap="round" strokeLinejoin="round" style={appIconStyles.getSvg(style)} {...props}>
        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
      </svg>
    );
  }
  return <RNText style={appIconStyles.getText(color, size, style)} {...props}>{filled ? '❤️' : '♡'}</RNText>;
};
  ...
  if (Platform.OS === 'web') {
    return (
      <svg width={size} height={size} viewBox={iconTokens.viewBox} fill={iconTokens.fillNone} stroke={getThemeColor(color)} strokeWidth={iconTokens.strokeWidth.default} strokeLinecap="round" strokeLinejoin="round" style={appIconStyles.getSvg(style)} {...props}>
        ...
        <line x1="7" y1="7" x2="7.01" y2="7" strokeWidth={iconTokens.strokeWidth.tagDot} />
      </svg>
    );
  }
  return <RNText style={appIconStyles.getText(color, size, style)} {...props}>🏷️</RNText>;
