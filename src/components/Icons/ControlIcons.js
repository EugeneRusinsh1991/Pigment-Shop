...
export const BackArrowIcon = ({ color, size = 16, style, ...props }) => {
  if (Platform.OS === 'web') {
    return (
      <svg width={size} height={size} viewBox={iconTokens.viewBox} fill={iconTokens.fillNone} stroke={getThemeColor(color)} strokeWidth={iconTokens.strokeWidth.bold} strokeLinecap="round" strokeLinejoin="round" style={getSvgStyle(style)} {...props}>
