...
function setupScrollObserver(domNode, fadeAnim, translateYAnim) {
  fadeAnim.setValue(0);
...
const ScrollFadeUp = React.forwardRef(function ScrollFadeUp({ children, style }, ref) {
  ...
  useLayoutEffect(() => {
    ...
    return setupScrollObserver(domNode, fadeAnim, translateYAnim);
  }, []);
