...
import { getMediaType } from './MediaTypeDetector';
 ...
 */
export default function MediaRenderer({ uri, style, resizeMode = 'cover', autoPlay = true, loop = true, muted = true, preload = 'auto', onReady }) {
