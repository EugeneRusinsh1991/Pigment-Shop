...
export class ObservabilityManager {
  ...
  private bindEvents() {
    this.emitter.on('ExplorerStarted', (e) => {
      this.globalStartTime = Date.now();
    });

    this.emitter.on('ScreenEntered', (e) => {
      this.pageStartTimes.set(e.context.currentScreen, Date.now());
    });
    ...
    this.emitter.on('ElementDiscovered', (e) => {
      this.domScanCount++;
      ...
      this.dispatch({
        ...
        interactiveElements: e.elementsCount, // Simplified
    ...
    this.emitter.on('InteractionCompleted', (e) => {
    ...
    this.emitter.on('NavigationCompleted', (e) => {
    ...
    this.emitter.on('BackNavigation', (e) => {
    ...
    this.emitter.on('DecisionMade', (e) => {
    ...
    this.emitter.on('ExplorerFinished', async (e) => {
